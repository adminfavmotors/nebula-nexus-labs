      ...
      <div className="space-y-0">
        {t.services.items.map((service, i) => (
          <div key={i}>
            ...
            <div
              className="reveal-left group -mx-3 grid grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-x-4 gap-y-3 rounded-xl px-3 py-6 transition-colors duration-300 hover:bg-primary/[0.04] sm:-mx-4 sm:px-4 lg:grid-cols-[auto_minmax(0,1fr)_minmax(9rem,12rem)_auto] lg:items-center lg:gap-x-8 2xl:grid-cols-[auto_minmax(0,1fr)_minmax(11rem,14rem)_auto]"
            ...
            >
              ...
              <span className="section-copy-light col-start-2 text-[0.95rem] lg:hidden">{service.price}</span>
