...
const ContactForm = () => {
  ...
  return (
    <Section id="contact" tone="light" ref={ref} containerClassName="contact-shell">
      <SectionTitle tone="light" revealClassName="reveal-element" className="mx-auto mb-10 max-w-[16ch] text-center md:mb-12 md:max-w-[17ch] 2xl:max-w-[18ch]" delay="0.05">
        {t.contact.title}
      </SectionTitle>
      <form
